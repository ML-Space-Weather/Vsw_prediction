...
class AttentionModule_stage0(nn.Module):
    # input size is 64*64
    def __init__(self, in_channels, out_channels, size1=(64, 64),
                 size2=(32, 32), size3=(16, 16), size4=(8, 8)):
    ...
    def forward(self, x):
        ...
        out_skip3_connection = self.skip3_connection_residual_block(
            out_softmax3)
        ...
        # print(self.interpolation2(out_softmax6).shape)
